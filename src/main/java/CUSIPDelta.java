...
public class CUSIPDelta {
    ...
    public URL getURL(String TransactionTimeOfLastRun) {
        ...
        try {
            String urlStr ="http://ownership.morningstar.com/ownershipdata/API/GetDataChange.aspx?changetype=summary&mostrecent=true&startdate=20170101010101&enddate=20170301000000";
